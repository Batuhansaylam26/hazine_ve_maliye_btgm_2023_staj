...
df=data[["Region","Population in thousands (2017)","GDP: Gross domestic product (million current US$)","Unemployment (% of labour force)","International trade: Exports (million US$)","Seats held by women in national parliaments %","CO2 emission estimates (million tons/tons per capita)","Energy supply per capita (Gigajoules)","Quality Of Life Index","Purchasing Power Index","Safety Index","Inflation, consumer prices (annual %)"]]
df_corr=df.corr()
