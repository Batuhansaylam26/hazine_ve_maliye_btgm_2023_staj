...
data=pandas.read_csv("/home/batuhan-saylam/Downloads/soci_econ_country_profiles.csv")
...
data5=data
data6=data
data["Health: Physicians (per 1000 pop.)"]=data["Health: Physicians (per 1000 pop.)"].astype(float)


data6=data6[["Infant mortality rate (per 1000 live births","Health: Physicians (per 1000 pop.)","Health: Total expenditure (% of GDP)"]]
...
fig31 = px.line(x=data5.groupby("Region",as_index=False)["Life expectancy at birth, female (years)"].mean()["Region"], y=data5.groupby("Region",as_index=False)["Life expectancy at birth, female (years)"].mean()["Life expectancy at birth, female (years)"],title="Ortalama")
fig31.add_bar(x=data5.groupby("Region",as_index=False)["Life expectancy at birth, male (years)"].mean()["Region"], y=data5.groupby("Region",as_index=False)["Life expectancy at birth, male (years)"].mean()["Life expectancy at birth, male (years)"])
      

fig32 = px.line(x=data5.groupby("Region",as_index=False)["Life expectancy at birth, female (years)"].max()["Region"], y=data5.groupby("Region",as_index=False)["Life expectancy at birth, female (years)"].max()["Life expectancy at birth, female (years)"],title="Maximum")
fig32.add_bar(x=data5.groupby("Region",as_index=False)["Life expectancy at birth, male (years)"].max()["Region"], y=data5.groupby("Region",as_index=False)["Life expectancy at birth, male (years)"].max()["Life expectancy at birth, male (years)"])
       
fig33 = px.line(x=data5.groupby("Region",as_index=False)["Life expectancy at birth, female (years)"].min()["Region"], y=data5.groupby("Region",as_index=False)["Life expectancy at birth, female (years)"].min()["Life expectancy at birth, female (years)"],title="Minimum")
fig33.add_bar(x=data5.groupby("Region",as_index=False)["Life expectancy at birth, male (years)"].min()["Region"], y=data5.groupby("Region",as_index=False)["Life expectancy at birth, male (years)"].min()["Life expectancy at birth, male (years)"])
